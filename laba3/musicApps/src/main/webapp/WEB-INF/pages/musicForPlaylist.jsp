...
<div class="main-cont" >
  <div class="main">
    <div class="wrap" style="width: 1300px;margin-left: 450px;">
      <div class="content-top" style="width: 1300px;">
        <div class="col_1_of_3 span_1_of_3" style="width: 920px;">
          <a >
            <div class="banner_content"><h2 style="margin-left: 200px;">Music<span> from this playlist</span></h2>
              <table class="table ">
                <thead>
                <tr>
                  <th></th>
                ...
                <c:forEach var="music" items="${musics}">
                  <tr>
                    <c:url var="addMusicFormUserPlaylist" value="/addMusicFormUserPlaylist?idMusic=${music.id}&idPerson=${users.id}&idPlaylist=${idPlaylist}&idPersonRedirect=${idPerson}" />
                    <c:url var="likeMusicFromuserPlaylist" value="/likeMusicFromuserPlaylist?idMusic=${music.id}&idPerson=${users.id}&idPlaylist=${idPlaylist}&idPersonRedirect=${idPerson}" />
                    ...
                    <td> <a href="${likeMusicFromuserPlaylist}" class="btn-sm" role="button"><span class="glyphicon glyphicon-heart"/>${music.likes}</a>  <a href="${addMusicFormUserPlaylist}" class="btn-sm" role="button" onclick="addsucces()"><span class="glyphicon glyphicon-plus"/> </a></td>
                  </tr>
                </c:forEach>
                </tbody>
              </table>
