          ...
          <a >
            <div class="banner_content"><h2 style="margin-left: 400px;">My<span> playlists</span></h2>
              ...
              <table class="table">
                ...
                <tbody>
                <c:forEach var="music" items="${playlistMusics}">
                  <tr>
                    <c:url var="delMusicPlaylist" value="/delMusicPlaylist?idMusic=${music.id}&idPlaylist=${idPlaylist}&idPerson=${users.id}" />
                    ...
                    <td ><a href=""><span class="glyphicon glyphicon-heart"/>${music.likes}</a>  <a href="${delMusicPlaylist}" class="btn-sm" role="button"><span class="glyphicon glyphicon-remove"/> </a></td>
                    <td></td>
                  </tr>
                </c:forEach>
              ...
              <c:url var="addMusicPlaylist" value="/addMusicPlaylist?idPlaylist=${idPlaylist}&idPerson=${users.id}" />
              <a href="${addMusicPlaylist}" style="margin-right: 300px;" class="btn btn-default " role="button" > Add music in playlist  <span class="glyphicon glyphicon-plus"/> </a>
            </div>
