  ...
  <div class="main">
    <div class="wrap" style="width: 1700px;margin-left: 110px;">
      <div class="content-top" style="width: 1700px;">
        <div class="col_1_of_3 span_1_of_3" style="width: 900px;margin-left: 400px;">
          <a >
            <div class="banner_content"><h2 style="margin-left: 270px;">All<span> playlists</span></h2>
              <table class="table ">
                <thead>
                <tr>
                ...
                <c:forEach var="playlist" items="${playlists}">
                  <tr>
                    <c:url var="alllikePlaylist" value="/alllikePlaylist?idPlaylist=${playlist.id}&idPerson=${users.id}" />
                    ...
                    <c:choose>
                      ...
                      <c:otherwise>
                        ...
                        <td> <a href="${alllikePlaylist}" class="btn-sm" role="button"><span class="glyphicon glyphicon-heart"/>${playlist.likes}</a></td>
                      </c:otherwise>
                    </c:choose>
                  </tr>
                </c:forEach>
