    ...
    <div class="wrap" style="width: 1700px;margin-left: 400px;">
      <div class="content-top" style="width: 1700px;">
        <div class="col_1_of_3 span_1_of_3" style="width: 1100px">
          <a >
            <div class="banner_content"><h2 style="margin-left: 400px;">Search<span> music</span></h2>
              <table class="table ">
                <thead>
                <tr>
                  <th></th>
                ...
                <c:forEach var="music" items="${musics}">
                  <tr>
                    <c:url var="addMusicFromSearch" value="/addMusicFromSearch?idMusic=${music.id}&idPerson=${users.id}" />
                    <c:url var="likeMusicFromSearch" value="/likeMusicFromSearch?idMusic=${music.id}&idPerson=${users.id}" />
                    ...
                    <c:choose>
                      ...
                      <c:otherwise>
                        <td> <a href="${likeMusicFromSearch}" class="btn-sm" role="button"><span class="glyphicon glyphicon-heart"/>${music.likes}</a>  <a href="${addMusicFromSearch}" class="btn-sm " role="button" onclick="addsucces()"><span class="glyphicon glyphicon-plus"/> </a></td>
                      </c:otherwise>
                    </c:choose>
