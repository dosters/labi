    ...
    <div class="wrap" style="width: 1700px;margin-left: 450px;">
      <div class="content-top" style="width: 1700px;">
        <div class="col_1_of_3 span_1_of_3" style="width: 920px;">
          <a >
            <div class="banner_content"><h2 style="margin-left: 340px;">Music<span> </span></h2>
              <table class="table ">
                <thead>
                <tr>
                  <th></th>
                ...
                <c:forEach var="music" items="${musics}">
                  <tr>
                    <c:url var="addMusicPlaylistFinal" value="/addMusicPlaylistFinal?idMusic=${music.id}&idPerson=${users.id}&idPlaylist=${idPlaylist}" />
                    ...
                    <td> <a href="" class="btn-sm" role="button"><span class="glyphicon glyphicon-heart"/>${music.likes}</a>  <a href="${addMusicPlaylistFinal}" class="btn-sm" role="button" onclick="addsucces()"><span class="glyphicon glyphicon-plus"/> </a></td>
                  </tr>
                </c:forEach>
                </tbody>
              </table>
              <c:url var="playlistMusic" value="/playlistMusic?id=${users.id}&idPlaylist=${idPlaylist}&idPerson=${users.id}" />
              <a style="margin-right: 270px;" href="${playlistMusic}" class="btn btn-default " role="button" ><span class="glyphicon glyphicon-circle-arrow-left"/> Back to playlist</a>
            </div>
          </a>
        </div>
