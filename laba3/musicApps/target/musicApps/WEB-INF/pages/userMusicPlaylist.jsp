...
<div class="banner">
  <div id="wrapper">
    ...
    <div  id="top" style="margin-left: 100px;" class="callbacks_container">
      <ul class="rslides" id="slider4">
        <li>
          <div class="slider-top">
            <a ><img src="http://rghost.ru/6lCNJGX6D/image.png" alt="" /></a>
          </div>
      </ul>
    </div>
  </div>
    ...
    <div class="wrap" style="width: 1700px;margin-left: 110px;">
      <div class="content-top" style="width: 1700px;">
        <div class="col_1_of_3 span_1_of_3" style="width: 920px;">
          <a >
            <div class="banner_content"><h2 style="margin-left: 300px;">User<span> music</span></h2>
              <table class="table ">
                <thead>
                <tr>
                  <th></th>
                ...
                <c:forEach var="music" items="${musics}">
                  <tr>
                    <c:url var="addMusicFromPerson" value="/addMusicFromPerson?idMusic=${music.id}&idPersonMain=${users.id}&idPersonRedirect=${personId}" />
                    <c:url var="likeMusicFromPerson" value="/likeMusicFromPerson?idMusic=${music.id}&idPersonMain=${users.id}&idPersonRedirect=${personId}" />
                    ...
                    <td> <a href="${likeMusicFromPerson}" class="btn-sm" role="button"><span class="glyphicon glyphicon-heart"/>${music.likes}</a>  <a href="${addMusicFromPerson}" class="btn-sm" role="button" onclick="addsucces()"><span class="glyphicon glyphicon-plus"/> </a></td>
                  </tr>
                </c:forEach>
                </tbody>
              </table>
        ...
        <div class="col_1_of_3 span_1_of_3" style="width: 400px;">
          <a >
            <div class="banner_content"><h2 style="margin-left: 20px;">User<span> playlists</span></h2>
              <table class="table ">
                <thead>
                <tr>
                ...
                <c:forEach var="playlist" items="${playlists}">
                  <tr>
                    <c:url var="likePlaylistIndex" value="/likePlaylistIndex?id=${users.id}&idPlaylist=${playlist.id}&idPerson=${personId}" />
                    <c:url var="playlistMusicIndex" value="/playlistMusicIndex?id=${users.id}&idPlaylist=${playlist.id}&idPerson=${personId}" />
                    <td ><a href="${playlistMusicIndex}">${playlist.name}</a></td>
                    <td> <a href="${likePlaylistIndex}" class="btn-sm" role="button"><span class="glyphicon glyphicon-heart"/>${playlist.likes}</a></td>
                  </tr>
                </c:forEach>
                </tbody>
              </table>
